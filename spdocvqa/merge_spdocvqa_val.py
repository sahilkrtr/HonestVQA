...
QA_JSON = os.path.join(os.path.dirname(__file__), 'spdocvqa_qas/val_v1.0_withQT.json')
IMAGES_DIR = os.path.join(os.path.dirname(__file__), 'spdocvqa_images')
OUTPUT_JSONL = os.path.join(os.path.dirname(__file__), '../spdocvqa_merged_val.jsonl')
